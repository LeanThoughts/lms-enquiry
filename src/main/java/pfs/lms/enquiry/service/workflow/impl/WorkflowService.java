...
import pfs.lms.enquiry.action.IEnquiryActionService;
...
import pfs.lms.enquiry.iccapproval.risknotification.RiskNotificationRepository;
    ...
    public Object startWorkflowProcessInstance(UUID businessProcessId,
        ...
        switch (processName) {
            case "Monitoring":
                ...
                loanMonitor.setWorkFlowStatusCode(02);
                loanMonitor.setWorkFlowStatusDescription("Sent for Approval");
            ...
            case "Appraisal":
                ...
                // Set the Work Flow Status Code "02" - Sent for Approval
                loanAppraisal.setWorkFlowStatusCode(02);
                loanAppraisal.setWorkFlowStatusDescription("Sent for Approval");
            ...
            case "EnquiryAction":
                ...
                // Set the Work Flow Status Code "02" - Sent for Approval
                enquiryAction.setWorkFlowStatusCode(02);
                enquiryAction.setWorkFlowStatusDescription("Sent for Approval");
            ...
            case "ICC Stage":
                ...
                // Set the Work Flow Status Code "02" - Sent for Approval
                iccApproval.setWorkFlowStatusCode(02);
                iccApproval.setWorkFlowStatusDescription("Sent for Approval");
            ...
            case "Prelim Risk Assessment":
                ...
                loanApplication = riskAssessment.getLoanApplication();
                objectId = loanApplication.getEnquiryNo().getId().toString();
            ...
            case "BoardApproval":
                ...
                // Set the Work Flow Status Code "02" - Sent for Approval
                boardApproval.setWorkFlowStatusCode(02);
                boardApproval.setWorkFlowStatusDescription("Sent for Approval");
            ...
            case "Sanction":
                ...
                // Set the Work Flow Status Code "02" - Sent for Approval
                sanction.setWorkFlowStatusCode(02);
                sanction.setWorkFlowStatusDescription("Sent for Approval");
    ...
    public Object approveTask(String processInstanceId, UUID businessProcessId, String processName, String username) throws Exception {
        ...
        switch (processName) {
            case "Monitoring":
                ...
                loanMonitor.setWorkFlowStatusCode(03);
            ...
            case "Appraisal":
                ...
                loanAppraisal = loanAppraisalRepository.getOne(businessProcessId);
                // Set the Work Flow Status Code "03" - Approved
                loanAppraisal.setWorkFlowStatusCode(03);
            ...
            case "Process Enquiry":
                ...
                enquiryAction = enquiryActionRepository.getOne(businessProcessId);
                // Set the Work Flow Status Code "03" - Approved
                enquiryAction.setWorkFlowStatusCode(03);
            ...
            case "ICC Stage":
                ...
                iccApproval = iccApprovalRepository.getOne(businessProcessId);
                // Set the Work Flow Status Code "03" - Approved
                iccApproval.setWorkFlowStatusCode(03);
            ...
            case "Prelim Risk Assessment":
                ...
                riskAssessment = riskAssessmentRepository.getOne(businessProcessId);
                // Set the Work Flow Status Code "03" - Approved
                riskAssessment.setWorkFlowStatusCode(03);
                riskAssessment.setWorkFlowStatusDescription("Approved");
                loanEnquiryId = riskAssessment.getLoanApplication().getEnquiryNo().getId().toString();
                processInstanceId = riskAssessment.getProcessInstanceId();
                break;
            case "Application Fee":
                //Fetch the Entity
                applicationFee = applicationFeeRepository.getOne(businessProcessId);
                // Set the Work Flow Status Code "03" - Approved
                applicationFee.setWorkFlowStatusCode(03);
            ...
            case "Board Approval":
                ...
                boardApproval = boardApprovalRepository.getOne(businessProcessId);
                // Set the Work Flow Status Code "03" - Approved
                boardApproval.setWorkFlowStatusCode(03);
            ...
            case "Sanction":
                ...
                sanction = sanctionRepository.getOne(businessProcessId);
                // Set the Work Flow Status Code "03" - Approved
                sanction.setWorkFlowStatusCode(03);
    ...
    public Object rejectTask(String processInstanceId, UUID businessProcessId, String processName, String rejectionReason, String requestorEmail) throws CloneNotSupportedException {
        ...
        switch (processName) {
            ...
            case "Process Enquiry":
                ...
                enquiryAction.setWorkFlowStatusCode(4);
            ...
            case "ICC Stage":
                ...
                iccApproval = iccApprovalRepository.getOne(businessProcessId);
                // Set the Work Flow Status Code "04" - Rejected
                iccApproval.setWorkFlowStatusCode(4);
            ...
            case "Prelim Risk Assessment":
                ...
                riskAssessment = riskAssessmentRepository.getOne(businessProcessId);
                // Set the Work Flow Status Code "04" - Rejected
                riskAssessment.setWorkFlowStatusCode(4);
            ...
            case "Application Fee":
                ...
                applicationFee = applicationFeeRepository.getOne(businessProcessId);
                // Set the Work Flow Status Code "04" - Rejected
                applicationFee.setWorkFlowStatusCode(4);
            ...
            case "Board Approval":
                ...
                boardApproval = boardApprovalRepository.getOne(businessProcessId);
                // Set the Work Flow Status Code "04" - Rejected
                boardApproval.setWorkFlowStatusCode(4);
            ...
            case "Sanction":
                ...
                sanction = sanctionRepository.getOne(businessProcessId);
                // Set the Work Flow Status Code "04" - Rejected
                sanction.setWorkFlowStatusCode(4);
...
//        variables.put("requestorEmail",  requestorEmail);
        ...
        switch (processName) {
            ...
            case "Prelim Risk Assessment":
                //Fetch the Entity
                riskAssessment = riskAssessmentRepository.getOne(businessProcessId);
                riskAssessmentService.processRejection(riskAssessment, username);
                break;
            case "Application Fee":
                //Fetch the Entity
                applicationFee = applicationFeeRepository.getOne(businessProcessId);
