...
public class BusinessPartnerIndustryService implements IBusinessPartnerIndustryService {
    ...
    public List<BusinessPartnerIndustryResource> findByPartnerId(UUID partnerId) {
        ...
        for (BusinessPartnerIndustry businessPartnerIndustry : businessPartnerIndustries) {
            ...
            businessPartnerIndustryResource.setIndustrySystem(String.valueOf(industrySystemRepository.
                    findIndustrySystemByCode(businessPartnerIndustry.getIndustrySystemId().toString())));
