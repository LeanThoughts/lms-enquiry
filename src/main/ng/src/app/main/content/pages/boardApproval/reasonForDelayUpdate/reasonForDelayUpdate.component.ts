...
@Component({
    selector: 'fuse-ba-reason-for-delay-update-dialog',
    templateUrl: './reasonForDelayUpdate.component.html',
    styleUrls: ['./reasonForDelayUpdate.component.scss'],
    animations: fuseAnimations,
    encapsulation: ViewEncapsulation.None
})
export class BoardApprovalReasonForDelayUpdateDialogComponent implements OnInit {
    ...
    submit(): void {
        if (this.reasonForm.valid) {
            ...
            if (this._dialogData.operation === 'addReason') {
                ...
                this._boardApprovalService.createBoardApprovalReasonForDelay(reasonForDelay).subscribe(() => {
                ...
                this._boardApprovalService.updateBoardApprovalReasonForDelay(this.selectedReason).subscribe(() => {
