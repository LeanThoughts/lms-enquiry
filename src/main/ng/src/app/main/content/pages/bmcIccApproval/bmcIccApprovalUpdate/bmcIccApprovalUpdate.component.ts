...
@Component({
    selector: 'fuse-bmc-icc-approval-update-dialog',
    templateUrl: './bmcIccApprovalUpdate.component.html',
    styleUrls: ['./bmcIccApprovalUpdate.component.scss'],
    animations: fuseAnimations,
    encapsulation: ViewEncapsulation.None
})
export class BMCICCApprovalUpdateDialogComponent implements OnInit {
    ...
    constructor(private _formBuilder: FormBuilder, private _bmcApprovalService: BMCApprovalService,
        public _dialogRef: MatDialogRef<BMCICCApprovalUpdateDialogComponent>, @Inject(MAT_DIALOG_DATA) public _dialogData: any,
    ...
    async uploadDocument1(file: FormData): Promise<any> {
        ...
        let httpData = await this._bmcApprovalService.uploadVaultDocument(file).toPromise();
