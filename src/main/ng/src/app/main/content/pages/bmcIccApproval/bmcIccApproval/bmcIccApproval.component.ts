...
@Component({
    selector: 'fuse-bmc-icc-approval-meeting',
    templateUrl: './bmcIccApproval.component.html',
    styleUrls: ['./bmcIccApproval.component.scss'],
    animations: fuseAnimations
})
export class BMCICCApprovalMeetingComponent {
    ...
    update(): void {
        // Open the dialog.
        const dialogRef = this._matDialog.open(BMCICCApprovalUpdateDialogComponent, {
            panelClass: 'fuse-bmc-icc-approval-update-dialog',
            width: '900px',
            data: {
