...
export class LoanEnquiryService implements Resolve<any> {
  ...
  financingTypes: any[] = [];
     ...
     */
    getFunctionalStatusDescription(functionalStatus: number): string {
        switch (functionalStatus) {
            ...
            case 5: return 'Sanction Stage';
            case 6: return 'Loan Documenation Stage';
            case 7: return 'Loan Disbursement Stage';
            case 8: return 'Monitoring';
            case 9: return 'Recovery';
            case 90: return 'Planned Completed';
            case 99: return 'Actual Completed';
        }
    }
