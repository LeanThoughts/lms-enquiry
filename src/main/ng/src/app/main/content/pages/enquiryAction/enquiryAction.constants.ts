export const productTypes = [
    { code: "301", value: "Bridge Loan" },
    { code: "302", value: "Short Term Loan" },
    { code: "303", value: "Term Loan" },
    { code: "304", value: "Debentures" },
    { code: "305", value: "Non Fund Based Loan" },
    { code: "30F", value: "Facilities" },
    { code: "310", value: "Facilities Drawdown-NFB Loan" },
    { code: "311", value: "Facilities Drawdown-Term Loan" },
