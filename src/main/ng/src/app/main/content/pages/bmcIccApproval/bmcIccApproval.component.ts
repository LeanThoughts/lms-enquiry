...
@Component({
    selector: 'fuse-bmc-approval',
    templateUrl: './bmcIccApproval.component.html',
    animations: fuseAnimations
})
export class BMCApprovalComponent implements OnInit, OnDestroy {
    ...
    constructor(private _formBuilder: FormBuilder, public _appService: AppService, private _matSnackBar: MatSnackBar,
                public _loanEnquiryService: LoanEnquiryService, private _bmcApprovalService: BMCApprovalService,
    ...
    sendForApproval(): void {
        ...
        this._bmcApprovalService.sendICCApprovalForApproval(this.iccApproval.id, name, email).subscribe(
            (response) => {
