...
export const entityComponentConfigs: { [key: string]: EntityUpdateComponentConfig } = 
{
    ...
    businessPartnerBasicInformation: {
        fieldsConfig: [
            ...
            {row: 2, span: 3, name: 'externalBPNumber', label: 'External BP Id', type: 'text' },
            {row: 2, span: 3, name: 'title', label: 'Title', type: 'select' },
            {row: 3, span: 3, name: 'partyName1', label: 'Name 1', type: 'text'},
            {row: 3, span: 3, name: 'partyName2', label: 'Name 2', type: 'text'},
            {row: 3, span: 3, name: 'searchTerm1', label: 'Search Term 1', type: 'text', required: true },
            {row: 3, span: 3, name: 'searchTerm2', label: 'Search Term 2', type: 'text' },

            {row: 4, span: 12, name: 'header2', type: 'header', label: 'Address Details' },
            {row: 5, span: 3, name: 'addressLine1', label: 'Street/House No.', type: 'text', required: true },
            {row: 5, span: 3, name: 'addressLine2', label: 'Street2', type: 'text' },
            {row: 5, span: 3, name: 'addressLine3', label: 'Street3', type: 'text' },
            {row: 5, span: 3, name: 'city', label: 'City', type: 'text', required: true },
            {row: 6, span: 3, name: 'postalCode', label: 'Postal Code', type: 'text' },
            {row: 6, span: 3, name: 'state', label: 'State/Region', type: 'select' },
            {row: 6, span: 3, name: 'country', label: 'Country', type: 'select' },
            {row: 6, span: 3, name: 'addressValidFromDate', label: 'Address Valid From Date', type: 'date' },

            {row: 7, span: 12, name: 'header3', type: 'header', label: 'Communication & Other Details' },
            {row: 8, span: 3, name: 'contactNumber', label: 'Telephone', type: 'text' },
            {row: 8, span: 3, name: 'email', label: 'Email', type: 'text', required: true },
            {row: 8, span: 3, name: 'mobileNumber', label: 'Mobile', type: 'text' },
            {row: 8, span: 3, name: 'faxNumber', label: 'Fax', type: 'text' },
            {row: 8, span: 3, name: 'legalForm', label: 'Legal Form', type: 'select' },
            {row: 8, span: 3, name: 'legalEntity', label: 'Legal Entity', type: 'select' },
            {row: 8, span: 3, name: 'houseBank', label: 'House Bank', type: 'select' }
        ]
    },
